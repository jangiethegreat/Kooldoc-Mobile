...
import com.example.kooldocandroidfinal.Cleaning.cleaningSchedule;
import com.example.kooldocandroidfinal.R;

public class installConditionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_install_condition);
    ...
    private void toSend() {
        Intent intent = new Intent(installConditionActivity.this, installationSchedule.class);
