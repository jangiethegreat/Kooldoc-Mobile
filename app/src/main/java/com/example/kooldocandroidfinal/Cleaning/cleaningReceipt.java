...
public class cleaningReceipt extends AppCompatActivity {


    String passACbrand,passACtype,passACUnitType,passNumberUnit,passselectedDate,passselectedTime;
    String Datevalue,Timevalue,Pricevalue,ServiceType,PaymentMethod,descriptionValue,ACHorsePower;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cleaning_receipt);
...
//-----------------------------------------------------------------------------//
        ...
        showBrand.setText(descriptionValue);
...
//                    progressBar.setVisibility(View.GONE);
                    Intent intent = new Intent(cleaningReceipt.this, ConfirmActivity.class);
