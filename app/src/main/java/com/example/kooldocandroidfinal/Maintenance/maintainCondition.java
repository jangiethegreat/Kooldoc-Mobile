...
import com.example.kooldocandroidfinal.Repair.repairCondition;

public class maintainCondition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maintain_condition);
    ...
    private void toSend() {
        Intent intent = new Intent(maintainCondition.this, maintenanceSchedule.class);
