...
public class installationSchedule extends AppCompatActivity {
    ...
    //intent filter
    String passACbrand,passACtype,passACUnitType,descriptionValue;
    int valueofService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_installation_schedule);
...
// Set minimum and maximum date range
        ...
        Toast.makeText(installationSchedule.this, "Select Timeslot First then select a date: " , Toast.LENGTH_LONG).show();
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(installationSchedule.this,InstallationDT.class);
...
//ignore insert data
            private void insertData() {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                Toast.makeText(installationSchedule.this, "Event added successfully", Toast.LENGTH_SHORT).show();
                            }
                        }, new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(installationSchedule.this, "Error adding event: " + error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                }) {
                    @Override
                ...
                Volley.newRequestQueue(installationSchedule.this).add(stringRequest);
            }});}
        ...
        calendarView.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(@NonNull CalendarView calendarView, int year, int month, int dayOfMonth) {
                ...
                if (dayOfWeek == Calendar.SATURDAY || dayOfWeek == Calendar.SUNDAY) {
                    ...
                    Toast.makeText(installationSchedule.this, "Not Accepting Booking on Weekends", Toast.LENGTH_SHORT).show();
                    submitButton.setEnabled(false);
                    return;
                }
                        ...
                        new Response.Listener<JSONArray>() {
                            ...
                            public void onResponse(JSONArray response) {
                                ...
                                if (dateTimePairs.contains(selectedDateTimePair)) {
                                    ...
                                    Toast.makeText(installationSchedule.this, "Selected date and time slot is not available", Toast.LENGTH_SHORT).show();
                                    alertMessage.setText("Not Available! \n Please Select New TimeSlot and Date");
                                    submitButton.setEnabled(false);
                                } else {
                                    // The selected date and time slot is not available
                                    Toast.makeText(installationSchedule.this, "Selected date and time slot is available", Toast.LENGTH_SHORT).show();
