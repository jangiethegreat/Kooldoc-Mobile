...
public class cleanConditionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clean_condition);
    ...
    private void toSend() {
        Intent intent = new Intent(cleanConditionActivity.this, cleaningSchedule.class);
